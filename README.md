# silversat
python script to receive and decode SSDV image from SilverSat cube sat (IL2P protocol). Work flawless with audio stream or recorded, like from satnogs observation, SDR , local WAV file.
